...
public class PerceptEvent extends Event {
  ...
  @DefaultValueSource
  public PerceptEvent(final Vector3D pos, final Vector3D speed, @DefaultValue("tools.PerceptEvent#NEW_0") final List<UAVBody> around, final boolean onZone) {
    this.pos = pos;
    this.around = around;
    this.onZone = onZone;
    this.speed = speed;
  ...
  @DefaultValueUse("tools.Vector3D,tools.Vector3D,java.util.List<uav.UAVBody>,boolean")
  @SyntheticMember
  ...
  @SyntheticMember
  private final static long serialVersionUID = -6034523L;
}
