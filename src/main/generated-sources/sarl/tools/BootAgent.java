...
public class BootAgent extends Agent {
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    try {
      ...
      this.graphical = Boolean.parseBoolean(((String) _get));
      Object _get_1 = occurrence.parameters[1];
      this.nbdrones = Integer.parseInt(((String) _get_1));
      Object _get_2 = occurrence.parameters[2];
      this.nbSurvivors = Integer.parseInt(((String) _get_2));
      Object _get_3 = occurrence.parameters[3];
      Utils.swarmInteractions = Boolean.parseBoolean(((String) _get_3));
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER.spawn(EnvAgent.class, Integer.valueOf(this.nbdrones), Integer.valueOf(this.nbSurvivors), Boolean.valueOf(this.graphical));
    if (this.graphical) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (other.nbSurvivors != this.nbSurvivors)
      return false;
    if (other.graphical != this.graphical)
      return false;
  ...
  public int hashCode() {
    ...
    result = prime * result + (this.graphical ? 1231 : 1237);
    return result;
  }
